...
rec {
  ...
  machines = {
    ...
    dekai = {
      key = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAILb5AB4h6J8GUQVO/61GmmlqBeHx5a7EpNKspbtPR4nl loli@dekai";
      print = "ssh-rsa  root@nixos";
      ip = mkip 4;
      iface = "eth0";
